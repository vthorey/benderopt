...
def test_lognormal_search_space_ok():
    search_space = {"mu": 1e-0, "sigma": 1e1, "low": 1e-5, "high": 1e5, "step": 1e-6, "base": 10}
...
def test_lognormal_search_space_bad_high_low():
    search_space = {"mu": 1e-0, "sigma": 1e1, "low": 1e5, "high": 1e5, "step": 1e-6, "base": 10}
...
def test_lognormal_search_space_bad_high_step():
    search_space = {"mu": 1e-0, "sigma": 1e1, "low": 1e-5, "high": 1e5, "step": 1e6, "base": 10}
