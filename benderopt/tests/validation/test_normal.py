...
def test_normal_search_space_no_mu():
    search_space = {"sigma": 1, "low": -5, "high": 5, "step": 0.1}
...
def test_normal_search_space_bad_mu():
    search_space = {"mu": [5], "sigma": 1, "low": -5, "high": 5, "step": 0.1}
...
def test_normal_search_space_no_sigma():
    search_space = {"mu": 0.5, "low": -5, "high": 5, "step": 0.1}
...
def test_normal_search_space_step_high():
    search_space = {"mu": 0.5, "sigma": 1, "low": -5, "high": 5, "step": 5}
...
def test_normal_search_space_set_step():
    search_space = {"mu": 0.5, "sigma": 1, "low": -5, "high": 5}
...
def test_normal_value():
    search_space = {"mu": 0, "sigma": 1, "low": -5, "high": 5, "step": 6, "base": 10}
